                ...
                <div class="row">
                        ...
                        <div class="widget about-widget">
                            <div class="widget-inner">
                                <a class="footer-logo" href="index.html">
                                    <img src="<?php echo base_url()?>assets_front/images/template/logo-footer.png" alt="Footer logo">
                                </a>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="widget app-widget">
                            ...
                            <div class="widget-inner">
                                <a class="google-play-download" href="#"><img src="<?php echo base_url()?>assets_front/images/icons/google-play.png" alt="Google Play Download"></a>
                                <a class="apple-store-download" href="#"><img src="<?php echo base_url()?>assets_front/images/icons/app-store.png" alt="Apple Store Download"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-5 col-xs-12 xs-text-center">
                        <p class="copyright-text">&copy; 2017 <a href="index.html">BigShow</a>. All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo base_url()?>assets_front/js/jquery.ajaxchimp.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAmiJjq5DIg_K9fv6RE72OY__p9jz0YTMI"></script>
    <script src="<?php echo base_url()?>assets_front/js/map.js"></script>
    <script src="<?php echo base_url()?>assets_front/js/custom.js"></script>
</body>


<!-- Mirrored from codepassenger.com/html/bigshow/tv-show.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Oct 2017 04:07:22 GMT -->
</html>
